...
//Event listner for nav links
	...
	function portfolio() {
		$(".body-container").empty();
		$(".body-container").append(
		'<div class="row"><div class="col-sm"><img src="assets/images/words.jpg" alt="words" class="image img-responsive" /><h2 class="portfolio-p"><a href="https://mbrennecke.github.io/Word-Guess-Game/">Word Guess Game</a></h2></div>	<div class="col-sm"><img src="assets/images/rpg.jpg" alt="RPG game" class="image img-responsive" />	<h2 class="portfolio-p"><a href="https://mbrennecke.github.io/unit-4-game/">Fantasy Card Game</a></h2></div>			<div class="col-sm"></div></div><div class="row"><div class="col-sm"><img src="assets/images/qa.jpg" alt="trivia game" class="image img-responsive" /><h2 class="portfolio-p"><a href="https://mbrennecke.github.io/TriviaGame/">Trivia Game</a></h2></div>	<div class="col-sm"><img src="assets/images/giftastic.jpg" alt="Giftastic" class="image img-responsive" /><h2 class="portfolio-p"><a href="https://mbrennecke.github.io/Giftastic/">Giftastic</a></h2></div>	<div class="col-sm"></div></div><div class="row"><div class="col-sm"><img src="assets/images/train.jpg" alt="model train" class="image img-responsive" /><h2 class="portfolio-p"><a href="https://mbrennecke.github.io/train-scheduler/">Train Schedule</a></h2></div><div class="col-sm"><img src="assets/images/rock-paper-scissors.jpg" alt="rock paper scissors" class="image img-responsive" /><h2 class="portfolio-p"><a href="#">Rock Paper Scissors</a></h2></div><div class="col-sm"></div></div>'
